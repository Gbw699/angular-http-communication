...
/* harmony import */ var _core_add_header_interceptor_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./core/add-header-interceptor.service */ 3143);
/* harmony import */ var _core_log_response_interceptor_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./core/log-response-interceptor.service */ 1401);
/* harmony import */ var _core_cache_interceptor_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./core/cache-interceptor.service */ 455);
    ...
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_12__.NgModule)({
        ...
        providers: [
            { provide: _angular_core__WEBPACK_IMPORTED_MODULE_12__.ErrorHandler, useClass: _core_book_tracker_error_handler_service__WEBPACK_IMPORTED_MODULE_7__.BookTrackerErrorHandlerService },
            {
                ...
                useClass: _core_add_header_interceptor_service__WEBPACK_IMPORTED_MODULE_8__.AddHeaderInterceptorService,
                multi: true,
            },
            {
                provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_13__.HTTP_INTERCEPTORS,
                useClass: _core_log_response_interceptor_service__WEBPACK_IMPORTED_MODULE_9__.LogResponseInterceptorService,
                multi: true,
            },
            {
                provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_13__.HTTP_INTERCEPTORS,
                useClass: _core_cache_interceptor_service__WEBPACK_IMPORTED_MODULE_10__.CacheInterceptorService,
                multi: true,
            },
        ],
...
/***/ 3143:
/*!********************************************************!*\
  !*** ./src/app/core/add-header-interceptor.service.ts ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "AddHeaderInterceptorService": () => (/* binding */ AddHeaderInterceptorService)
/* harmony export */ });
...
class AddHeaderInterceptorService {
    intercept(req, next) {
...
/***/ 455:
/*!***************************************************!*\
  !*** ./src/app/core/cache-interceptor.service.ts ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
CacheInterceptorService = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__decorate)([
...
/***/ 1401:
/*!**********************************************************!*\
  !*** ./src/app/core/log-response-interceptor.service.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "LogResponseInterceptorService": () => (/* binding */ LogResponseInterceptorService)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tslib */ 4762);
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/common/http */ 1841);
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/core */ 7716);
...
let LogResponseInterceptorService = class LogResponseInterceptorService {
    intercept(req, next) {
...
LogResponseInterceptorService = (0,tslib__WEBPACK_IMPORTED_MODULE_2__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_3__.Injectable)()
], LogResponseInterceptorService);
...
let EditBookComponent = class EditBookComponent {
    ...
    ngOnInit() {
        ...
        this.dataService.getOldBookById(bookID).subscribe((data) => console.log(`Old Book Title:  ${data.bookTitle}`), (err) => console.log(err));
    }
    setMostPopular() {
